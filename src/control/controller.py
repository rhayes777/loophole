        ...
        for event in pygame.event.get():
            if hasattr(event, "joy"):
                ...
                key_dict = {
                    ...
                    (115, 2): (0, MockEvent(event_type=7, axis=1, value=1)),
                    (115, 3): (0, MockEvent(event_type=7, axis=1, value=0)),
                    (119, 2): (0, MockEvent(event_type=7, axis=0, value=-1)),
                    (119, 3): (0, MockEvent(event_type=7, axis=0, value=0)),
                    (120, 2): (0, MockEvent(event_type=7, axis=0, value=1)),
                    (120, 3): (0, MockEvent(event_type=7, axis=0, value=0)),
                    ...
                    (104, 2): (1, MockEvent(event_type=7, axis=1, value=-1)),
                    (104, 3): (1, MockEvent(event_type=7, axis=1, value=0)),
                    (106, 2): (1, MockEvent(event_type=7, axis=1, value=1)),
                    (106, 3): (1, MockEvent(event_type=7, axis=1, value=0)),
                    (117, 2): (1, MockEvent(event_type=7, axis=0, value=-1)),
                    (117, 3): (1, MockEvent(event_type=7, axis=0, value=0)),
                    (109, 2): (1, MockEvent(event_type=7, axis=0, value=1)),
                    (109, 3): (1, MockEvent(event_type=7, axis=0, value=0)),
